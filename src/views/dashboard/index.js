...
const dashSalesData = [
  ...
  { title: 'Driver Earnings', amount: '$2.942.32', icon: 'icon-arrow-up text-c-green', value: 10, class: 'progress-c-theme2' },
  { title: 'Deductions from Promotions', amount: '$8.638.32', icon: 'icon-arrow-up text-c-green', value: 70, color: 'progress-c-theme' }
];
const dashSalesData2 = [
  { title: 'Total Riders', amount: '35', icon: 'icon-arrow-up text-c-green', value: 10, class: 'progress-c-theme' },
  { title: 'Charge per KM (Private)', amount: 'N400', icon: 'icon-arrow-up text-c-green', value: 10, class: 'progress-c-theme2' },
  { title: 'Active Riders', amount: '20', icon: 'icon-arrow-up text-c-green', value: 10, class: 'progress-c-theme' },
  { title: 'Charge per KM (Shared)', amount: 'N300', icon: 'icon-arrow-up text-c-green', value: 10, class: 'progress-c-theme2' }
];
  ...
  return (
    <React.Fragment>
      <Row>
              ...
              <Card>
                <Card.Body>
                  ...
                  <div className="row d-flex align-items-center">
                    <div className="col-7">
                      <h3 className="f-w-300 d-flex align-items-center m-b-0">N3,550,000</h3>
                    </div>
        ...
        <Col md={12} xl={12}>
          <h6 className="mb-1"> Users Summary</h6>
        </Col>
        <Col md={6} xl={4}>
          <Card>
            <Card.Body className="border-bottom">
              ...
              <div className="row d-flex align-items-center">
                <div className="col">
                  <span className="d-block text-uppercase">Total Driver Application</span>
                  <h3 className="f-w-300">55</h3>
                </div>
              </div>
            </Card.Body>
        ...
        {/* <div style={{ backgroundColor: 'red' }}>kkk</div>
          <Row>
            <Col md={6} xl={6}>
              kk
            </Col>
